...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-vapor-file-field', __webpack_require__(12));
    Vue.component('detail-vapor-file-field', __webpack_require__(15));
    Vue.component('form-vapor-file-field', __webpack_require__(25));
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImageLoader__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImageLoader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__ImageLoader__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { ImageLoader: __WEBPACK_IMPORTED_MODULE_0__ImageLoader___default.a },
...
var update = __webpack_require__(20)("2b388863", content, false, {});
    ...
    _c(
      ...
      [
        ...
        _vm.field.value && !_vm.imageUrl
          ? [
              _c("span", { staticClass: "break-words" }, [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DeleteButton__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DeleteButton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__DeleteButton__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_laravel_nova__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_laravel_vapor__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_laravel_vapor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_laravel_vapor__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { DeleteButton: __WEBPACK_IMPORTED_MODULE_2__DeleteButton___default.a, ImageLoader: __WEBPACK_IMPORTED_MODULE_1__ImageLoader___default.a },
    data: function data() {
        return {
            file: null,
            fileName: '',
    ...
    mounted: function mounted() {
        ...
        this.field.fill = function (formData) {
            if (_this.fileUuid) {
                formData.append(_this.field.attribute, _this.fileKey);
                formData.append(_this.field.attribute + '.uuid', _this.fileUuid);
                formData.append(_this.field.attribute + '.name', _this.fileName);
                formData.append(_this.field.attribute + '.key', _this.fileKey);
                formData.append(_this.field.attribute + '.bucket', _this.fileBucket);
                formData.append(_this.field.attribute + '.type', _this.fileType);
            }
        };
    },
    ...
    methods: {
        ...
        fileChange: function fileChange(event) {
            ...
            if (this.file) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_laravel_vapor___default.a.store(this.file, {
                    progress: function progress(_progress) {
                        _this2.uploadProgress = Math.round(_progress * 100);
                    }
                }).then(function (response) {
                    console.log('pushed');
                    _this2.fileData.uuid = response.uuid;
                    _this2.fileData.key = response.key;
                    _this2.fileData.bucket = response.bucket;
                }).catch(function (error) {
                    console.log('died');
                });
            }
...
var e=__webpack_require__(34),t=function(){};t.prototype.store=function(t,r){void 0===r&&(r=null);try{return Promise.resolve(e.post("/vapor/signed-storage-url",{bucket:r.bucket||"",content_type:r.contentType||t.type,expires:r.expires||""})).then(function(o){return void 0===r.progress&&(r.progress=function(){}),Promise.resolve(e.put(o.data.url,t,{headers:o.data.headers,onUploadProgress:function(e){r.progress(e.loaded/e.total)}})).then(function(e){return o.data.extension=t.name.split(".").pop(),o.data})})}catch(e){return Promise.reject(e)}},module.exports=new t;
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _c(
          "span",
          {
            staticClass: "form-file mr-4",
            class: { "opacity-75": _vm.isReadonly }
          },
          [
            _c("input", {
              ref: "fileField",
